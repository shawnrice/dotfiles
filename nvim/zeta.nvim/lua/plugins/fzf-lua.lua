local M = {
  ...
  config = function(_, opts)
    ...
    vim.keymap.set("n", "<leader>of", "<cmd>FzfLua files<cr>", { noremap = true, desc = "[F]ind [f]iles" })
    vim.keymap.set("n", "<leader>fr", "<cmd>FzfLua oldfiles<cr>", { noremap = true, desc = "[F]ind [r]ecent files" })
    vim.keymap.set("n", "<leader>og", "<cmd>FzfLua live_grep<cr>", { noremap = true, desc = "[F]ind [g]rep" })
    vim.keymap.set("n", "<leader>fb", "<cmd>FzfLua buffers<cr>", { noremap = true, desc = "[F]ind [b]uffers" })
    vim.keymap.set("n", "<leader>fl", "<cmd>FzfLua blines<cr>", { noremap = true, desc = "[F]ind [l]ines in buffer" })
    vim.keymap.set(
      "n",
      "<leader>fL",
      "<cmd>FzfLua lines<cr>",
    ...
    vim.keymap.set("n", "<leader>ca", "<cmd>FzfLua lsp_code_actions<cr>", { noremap = true, desc = "[C]ode [A]ctions" })
    vim.keymap.set(
      "n",
      "<leader>fd",
    ...
    vim.keymap.set("n", "<leader>fR", "<cmd>FzfLua resume<cr>", { noremap = true, desc = "[F]ind [R]esume" })

#!/bin/bash
# Single-line statusline with visual context progress bar
#
# [Model] folder | branch | progress bar context% | $cost | duration ↻ cache%
#
...
line="$line $(printf '\033[94m📁 %s\033[0m' "$folder_name")"
